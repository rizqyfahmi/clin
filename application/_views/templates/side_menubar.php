        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('createProduct', $user_permission) || in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
            <li class="treeview" id="mainProductNav">
              ...
              <ul class="treeview-menu">
                ...
                <?php endif; ?>
                <?php if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="manageProductNav"><a href="<?php echo base_url('products/main') ?>"><i class="fa fa-circle-o"></i> Manage Main Store</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
            <li class="treeview" id="mainOrdersNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createOrder', $user_permission) || in_array('viewOrder', $user_permission)): ?>
                <li id="manageOrdersNav"><a href="<?php echo base_url('orders') ?>"><i class="fa fa-circle-o"></i> Laundry Request List</a></li>
                <?php endif; ?>
                <?php if(in_array('createOrder', $user_permission) || in_array('viewOrder', $user_permission)): ?>
                <li id="manageOrdersNav"><a href="<?php echo base_url('orders/orderin') ?>"><i class="fa fa-circle-o"></i> Laundry Return List</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
